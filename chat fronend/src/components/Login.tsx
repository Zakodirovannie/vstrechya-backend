        ...
        <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
          ...
          <div className="-space-y-px rounded-md">
            <input
              ...
              className="mb-5 border-gray-300 text-gray-900 placeholder-gray-300 focus:ring-gray-500 focus:border-gray-500 block w-full pr-10 focus:outline-none sm:text-sm rounded-md"
            />
            <input
